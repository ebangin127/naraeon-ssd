...
type
  TFileSystem = (FS_UNKNOWN, FS_NTFS, FS_exFAT, FS_FAT32, FS_FAT16);

function DetermineFS(DriveLetter: String): TFileSystem;
begin
  //blank...
end;

function GetNTFSPartitionInfo(DriveLetter: String;
...
function GetFATPartitionInfo(DriveLetter: String;
  PartSize: Int64): TPartInfo;
var
