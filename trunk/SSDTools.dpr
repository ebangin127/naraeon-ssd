...
uses
  ...
  uFixedDriveListGetter in 'WindowsFileAPI\Partition\uFixedDriveListGetter.pas',
  uMotherDriveGetter in 'WindowsFileAPI\Partition\uMotherDriveGetter.pas',
  uBruteForcePhysicalDriveListGetter in 'WindowsFileAPI\PhysicalDrive\uBruteForcePhysicalDriveListGetter.pas',
  uDiskGeometryGetter in 'WindowsFileAPI\PhysicalDrive\uDiskGeometryGetter.pas',
  uDriveAvailabilityGetter in 'WindowsFileAPI\PhysicalDrive\uDriveAvailabilityGetter.pas',
  uMixedPhysicalDriveListGetter in 'WindowsFileAPI\PhysicalDrive\uMixedPhysicalDriveListGetter.pas',
  uPartitionListGetter in 'WindowsFileAPI\PhysicalDrive\uPartitionListGetter.pas',
  uWMIPhysicalDriveListGetter in 'WindowsFileAPI\PhysicalDrive\uWMIPhysicalDriveListGetter.pas',
  uCommandSet in 'WindowsFileAPI\Abstraction\uCommandSet.pas',
  uATACommandSet in 'WindowsFileAPI\PhysicalDrive\uATACommandSet.pas',
