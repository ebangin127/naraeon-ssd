...
begin
  ...
  ShellExecute(0, 'open',
              PChar(AppPath + 'unetbootin\unetbootin.exe'), PChar('method=diskimage' +
              ' isofile="' + FromISO +'" installtype=usb targetdrive=' +
              Copy(DestDrive, 1, 3) + ' autoinstall=y'), nil, SW_NORMAL);
