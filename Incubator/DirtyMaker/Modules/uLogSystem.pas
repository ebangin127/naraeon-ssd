...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if OnlyCount then
          Average30 := Format('%.1f',[((StrToUInt64(CurrGig) - (StrToUInt64(OneGigList[(CurrDay * 2) + 1]))) / (Now - (StrToDateTime(OneGigList[CurrDay * 2], FSet))))])
        else
      ...
      begin
        if OnlyCount then
          Average90 := Format('%.1f',[((StrToUInt64(CurrGig) - (StrToUInt64(OneGigList[(CurrDay * 2) + 1]))) / (Now - StrToDateTime(OneGigList[CurrDay * 2], FSet)))])
        else
      ...
      begin
        if OnlyCount then
          Average180 := Format('%.1f',[((StrToUInt64(CurrGig) - (StrToUInt64(OneGigList[(CurrDay * 2) + 1]))) / (Now - StrToDateTime(OneGigList[CurrDay * 2], FSet)))])
        else
